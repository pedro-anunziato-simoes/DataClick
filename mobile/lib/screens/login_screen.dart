...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    try {
      print('[LoginScreen] Iniciando processo de login');
      ...
      if (success && mounted) {
        print('[LoginScreen] Navegando para home');
      ...
      print('[LoginScreen] Erro no login: $e');
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
  ...
  void _navigateToRegister() {
    print('[LoginScreen] Navegando para registro');
